      ...
      <section class="links">
        <div class="links-inner">
          <ul>
            ...
            <li><a href="#">Category halo 1</a></li>
            <li><a href="#">Category halo 2</a></li>
            <li><a href="#">Category halo 3</a></li>
            <li><a href="#">Category halo 4</a></li>
            <li><a href="#">Category halo 5</a></li>
          </ul>
          <ul>
            <li>
              <h3>Lead</h3>
